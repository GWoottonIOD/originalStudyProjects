...
function insertPlants(result){
    let plantsInsert= 'INSERT INTO PLANTS (PlantIMGURL, PlantCName, PlantLName, PlantVitamins, PlantMinerals, PlantPharmaProps, PlantDesc, PlantLike) VALUES ?'
    let plantsArray=[]
    for (let p of plant_data){
        plantsArray.push([p.PlantIMGURL, p.PlantCName, p.PlantLName, p.PlantVitamins, p.PlantMinerals, p.PlantPharmaProps, p.PlantDesc, p.PlantLike])
    }
