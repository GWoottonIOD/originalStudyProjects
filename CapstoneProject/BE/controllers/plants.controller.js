...
exports.update = (req, res) => {
  ...
  const newPlantLike = req.body.PlantLike
  Plants.updateOne(id, newPlantCName, newPlantLName, newPlantVitamins, newPlantMinerals, newPlantPharmaProps, newPlantIMGURL, NewPlantDesc, newPlantLike, (err, data) => {
...
exports.updateLike = (req, res) => {
  const id = req.params.id;
  const newPlantLike = req.body.PlantLike
  Plants.updateLike(id, newPlantLike, (err, data) => {
    // console.log(newPlantLike)
    if (err)
      res.status(500).send({
        message:
