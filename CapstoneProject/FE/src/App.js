...
import PlantThemeBulk from './PlantThemeBulk'
...
export const UserLikeContext = React.createContext();
...
function App() {
  ...
  return (
    ...
    <UserLikeContext.Provider value={{userLike, setUserLike}}>
    ...
    <div>
      <Navbar/>
        <Routes>
            ...
            <Route path='/plantinfo' element={<PlantThemeBulk />}>
              <Route path=':plantid' element={<PlantInfo/>}/>
            </Route>
            <Route path='/plantinfoedit' element={<PlantThemeBulk/>}>
